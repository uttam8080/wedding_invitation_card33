...
import { Sparkles, Music, Crown, Heart } from 'lucide-react';
import './Carousel.css';
...
const DEFAULT_ITEMS = [
  {
    ...
    description:
      'Auspicious beginning with holy rituals to seek lord Ganesha’s divine blessings.',
    id: 1,
    icon: <Crown className="carousel-icon" />,
  },
  {
    title: 'Haldi & Mehendi',
    description:
      'Vibrant turmeric pastes, intricate henna artistry, and festive dhol beats.',
    id: 2,
  ...
  },
  {
    title: 'Royal Sangeet',
    description:
      'A grand evening of music, dance performances, and celebration.',
    id: 3,
  ...
  },
  {
    ...
    description:
      'The sacred Seven Pheras under the floral mandap by Lake Pichola.',
    id: 4,
        ...
        <>
          <div className={`carousel-item-header ${round ? 'round' : ''}`}>
            <span className="carousel-icon-container">
              {item.icon || <Sparkles className="carousel-icon" />}
            </span>
          </div>
